...
const AssetMaster = () => {
  ...
  return <>
    <Header />
    <main className="main-content main-asset-sheet">
      <section className="main-content-wrap">
        ...
        <p className="body-text">Phasellus non egestas diam, sit amet blandit orci. Suspendisse porttitor auctor eros vel sodales. Donec bibendum facilisis hendrerit. Sed ac odio cursus, lobortis dolor id, lacinia est. Donec rutrum, est vel commodo ultricies, ipsum mi iaculis sapien, id auctor magna tortor vehicula orci. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Praesent auctor semper magna consectetur vestibulum.</p>

        <h3 className="heading heading-content">Normal Copy with bold text</h3>
        <p className="body-text">Proin viverra enim vel dui finibus elementum. <strong>Nulla convallis dui eu neque maximus tempus et sed nisl.</strong> Pellentesque et nisl dictum, rhoncus purus non, tempus purus. Nam gravida dui ac magna gravida, ac suscipit sapien porta. Duis malesuada nec quam eu aliquet. Morbi tristique finibus malesuada. Aliquam erat volutpat. Praesent semper arcu egestas, ultricies quam ut, convallis metus.</p>

        <h3 className="heading heading-content">Normal Copy with italic text</h3>
        <p className="body-text">Morbi id magna nec metus efficitur aliquet. <em>Vestibulum pellentesque tincidunt massa vel rhoncus.</em> Fusce sit amet ex eros. Fusce pulvinar blandit magna. Etiam non arcu nec augue vehicula suscipit id quis risus. Pellentesque bibendum eu magna in lacinia. Nullam eu consectetur lorem, nec venenatis dui.</p>

        <h3 className="heading heading-content">Normal Copy with hyperlink text</h3>
        <p className="body-text">Donec sollicitudin a arcu eget vehicula. Aliquam malesuada eu <a href="https://developer.mozilla.org/" target="_blank" rel="noopener noreferrer">velit tempus convallis</a>. Aenean nec interdum nunc. Nam non arcu porta magna commodo pulvinar. Praesent accumsan vulputate condimentum. Nunc bibendum massa libero, et facilisis ipsum aliquet quis. Praesent in orci non sapien suscipit iaculis. Suspendisse non facilisis mauris, eget facilisis ex. Sed viverra sagittis enim.</p>
